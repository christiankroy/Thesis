...
\section{Nucleic Acid Polymers}
  ...
  \subsection{From Long to Small: Precursor processing to mature piRNAs}
    ...
    \begin{figure}\small % Mammalian piRNA Pathway
     ...
     \todo[inline]{Need to clean this piRNA function section up! Start with the reviews and work backwards. This review is good `Luteijn2013` } % **************************
    ...
    % Need to cite the Mourolotos paper.
