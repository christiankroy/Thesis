...
\section{Nucleic Acid Splicing}\label{hd: Nucleic Acid Splicing}
  ...
  \subsection{\flies{} \dscam{}}\label{sec:Dscam}
    ...
    \dscam{} use in two very different biologically roles has been summerized previously \citep{Hemani2012}. 

    %3. Umass guy Tzuman lee = \citep{Shi2007}
...
\section{Long Nucleic Acid Polymers}\label{hd: piRNA section}
  ...
  \subsection{Mouse piRNAs are different}\label{sec:Mouse piRNAs}
    ...
    \begin{figure}[htbp] % Mammalian piRNA Pathway
      \centering 
      ...
      \caption[A model for Mammalian piRNA biogenesis]
      {
        ...
        abel{fig:Mammalian piRNA BioGensis; MolCel2013 Review}
      \end{figure}
