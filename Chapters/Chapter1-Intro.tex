...
\section{Nucleic Acid Splicing}\label{hd: Nucleic Acid Splicing}
  ...
  \subsection{Alternative Splicing}\label{sec: AS}
    ...
    \todo[inline]{Insert information on RNASeq looking for splicing!}

    \citep{Kelemen2013}

    \citep{Barbosa-Morais2012,Merkin2012}  % Pair of papers in science, dec 2012 that discuss evolution using RNA-Seq 
  ...
  \subsection{Coordination in splicing}\label{sec: Coordination in splicing}
    ...
    \todo{Need to transition better here. Logic isn't great!}
    ...
    \missingfigure{insert my version of the chromatin figure}
  ...
  \subsection{\flies{} \dscam{}}\label{sec:Dscam}
    ...
    In 2005 the Zipersky lab published \citep{Hattori2005a} the first in a series of quality reports describing the function and diversity of \dscam{} from a genetic approach. \citep{Hattori2008,Hattori2009} 
    \todo[inline]{Insert Hattori Series Summary}
    ...
    \todo[inline]{Need transition from Dscam to Rnl2!}
...
\section{Nucleic Acid Ligation}\label{hd:Nucleic Acid Ligation}
  ...
  \subsection{T4 RNA Ligase 2 (Rnl2)}\label{sec:Rnl2}
    ...
    \todo[inline]{Discuss \cite{Reuveni2014} on importance of enzyme unbinding to the speed of reactions.} 
    %That doesn't get at a reference that talks about slow dissociation of nucleic-acid interacting proteins, for which even Wee said he didn't know a fantastic reference.

    \todo[inline]{Transition from Rnl2 to long RNAs/ piRNA precusors somehow.}
...
\section{Nucleic Acid Polymers}\label{hd: piRNA section}
  ...
  \subsection{From short reads to full-length transcripts}\label{subsec: Tx Assembly}
    ...
    \todo[inline]{Use Blower2014 to continue/refine discussion}