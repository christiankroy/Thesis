...
%----------------------------------------------------------------------------------------
\section{Deciphering a splicing code}
%----------------------------------------------------------------------------------------
...
\begin{figure}[htbp]
	\centering 
	\includegraphics{Figures/DscamAnatomy.pdf}
	\caption[Important \dscam{} expression during \textit{Drosophila melanogaster life} cycle]
	{
