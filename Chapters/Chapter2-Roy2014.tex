	...
	\subsection{Analysis of \dscam{} transcripts}
		...
		\begin{figure}[htbp] % FIGURE S4
		  ...
		  {Roy et al 2014 Figure S4 \\
		  	\todo[inline]{Insert Roy S4 Figure Caption} % **************************
		    \hl{Figure Caption}
		    }
		...
		\todo[inline]{Insert Neurogensis Reference} % **************************
		...
		\begin{figure}[htbp] % FIGURE S5
			  ...
			  {Roy et al 2014 Figure S5 \\
			  	\todo[inline]{Insert Supplemental Roy2014 S5 Caption} % **************************
			    \hl{Figure Caption}
			    }
...
\section{Materials and Methods}\label{c2sec: Methods}
  ...
  \begin{description}
  	\item[Cell lines and Drosophila melanogaster stocks] \hfill \\
		...
		Error bars represent the standard error of the mean of the experimental replicates. Errors were propagated from individual standard deviations according to the formula (
		\todo[inline]{Insert Proper of error Formula} % **************************).
		)
