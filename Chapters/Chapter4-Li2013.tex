...
\label{Chapter4} 
\lhead{Chapter 4. \emph{A-MYB Initiates Pachytene piRNA Production}}
%----------------------------------------------------------------------------------------
\todo[inline]{How do I include the supplemental tables?!}
%----------------------------------------------------------------------------------------
\section{INTRODUCTION}\label{c4-intro}
...
\section{RESULTS}
  ...
  \subsection{Defining piRNA-Producing Transcripts in the Mouse Testis}
    ...
    \begin{figure}[htbp] % Figure 1
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig1.eps}
      ...
      \label{fig:MolCelF1}
      \end{figure}
    \begin{figure}[htbp] % Figure S1
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS1.eps}
  ...
  \subsection{Three Classes of piRNAs During Post-Natal Spermatogenesis}
    ...
    \begin{figure}[htbp] % Figure 2
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig2.eps}
      ...
      \label{fig:MolCelF2}
      \end{figure}
    \begin{figure}[htbp]\tiny % Figure S2
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS2.eps}
    ...
    \begin{figure}[htbp] % Figure 3
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig3.eps}
      \caption[Examples of Pachytene piRNA Genes]
      {
     	...
     	\label{fig:MolCelF3}
   		\end{figure}
    \begin{figure}[htbp] % Figure S3
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS3.eps}
  ...
  \subsection{\amyb{} Regulates Pachytene piRNA Precursor Transcription}
    ...
    \begin{figure}[htbp] % Figure 4
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig4.eps}
      ...
      \label{fig:MolCelF4}
    	\end{figure}
    \begin{figure}[htbp] % Figure S4
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS4.eps}
  ...
  \subsection{\amyb{} Regulates Pachytene piRNA Production}
    ...
    \begin{figure}[htbp] % Figure 5
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig5.eps}
      ...
      \label{fig:MolCelF5}
   	  \end{figure}
    \begin{figure}[htbp] % Figure S5
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS5.eps}
  ...
  \subsection{\amyb{} Regulates Expression of piRNA Biogenesis Factors}
    ...
    \begin{figure}[htbp] % Figure 6
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig6.eps}
      ...
      \label{fig:MolCelF6}
    	\end{figure}
    \begin{figure}[htbp] % Figure S6
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS6.eps}
  ...
  \subsection{A-MYB and the Pachytene piRNA Regulatory Circuitry}
    ...
    \begin{figure}[htbp] % Figure 7
      \centering
      \includegraphics{Figures/Chapter4/MolCel2013_Fig7.eps}
      ...
      \label{fig:MolCelF7}
    	\end{figure}
    \begin{figure}[htbp] % Figure S7
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS7.eps}
  ...
  \subsection{Feed-Forward Regulation of piRNA Production is Evolutionarily Conserved}
    ...
    \begin{figure}[htbp] % Figure 8
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_Fig8.eps}
      ...
      \label{fig:MolCelF8}
    	\end{figure}
    \begin{figure}[htbp] % Figure S8
      \centering 
      \includegraphics{Figures/Chapter4/MolCel2013_FigS8.eps}
