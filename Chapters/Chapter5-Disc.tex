...
\section{The Future of Dynamic long RNAs}
  ...
  % See Writing Fragments for Rumseld lead in! \input{Fragments/Rumsfeld}
...
\section{Future SeqZip development and use}
  ...
  \subsection{Assay Modifications}
    ...
    % That boils down to 3 things
      % 1) Use of T39A which (all from \citep{Nandakumar2006} (
      % 2) Use of an LNA at the penultimate base on the 5\textprime~ side of the nick.
      % 3) Use of a ribose on the 5\textprime~ most residue on the 3\textprime~ side of the nick.

    One of the most potentially exciting improvements in the SeqZip assay comes from a mutant discussed in \citet{Nandakumar2006}. In this, and past studies, the T39A mutation alleviates structural constrains on having a penultimate 2\textprime~ OH on the 3\textprime~ side of the nick. 
...
\section{Final thoughts}
  ...
  % See Fragment on Highschool biology class - not sure if it belongs here. \input{Fragments/HighSchool}
