...
% Macro Definitions
%----------------------------------------------------------------------------------------
% Inserting Figures (Width <= 5.75"; Height <= 8")
\newcommand\InsertFigure[4]{
	% 1 = File Name
	% 2 = Figure Title (As put in TOC)
	% 3 = Figure Caption
	% 4 = Figure Hyperlink Label
	\begin{figure}[htbp]
		\centering 
		\includegraphics{Figures/#1}
		\rule{35em}{0.5pt}
		\caption[#2]{#2\\[0.25cm] #3}
		\label{#4}
	\end{figure}
}
...
Chapter III has been published previously as Li, X. Z. Z., Roy, C. K. K., Dong, X., Bolcun-Filas, E., Wang, J., Han, B. W. W., … Zamore, P. D. D. (2013). An Ancient Transcription Factor Initiates the Burst of piRNA Production during Early Meiosis in Mouse Testes. Molecular Cell, 50(1), 1–15. doi:10.1016/j.molcel.2013.02.016
...
% The references are stored in the file named "Bibliography_2.bib"
